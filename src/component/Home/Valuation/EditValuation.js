...
async function uploadFile( valfileNo, pdffile, name, fileType){
  ...
  return (
     ...
     <div className="  w-full md:px-24 sm:px-0 text-black ">
      ...
      {
    // real time show
   user.email==undefined?<>undefined</>:<>{user.email}
...
<div class="bg-blue-100 border border-blue-300 text-blue-700 px-4 py-3 rounded-lg flex items-center space-x-2" role="alert">
  ...
  <span> Please cautious while.</span>
  <span className="font-extrabold">{formclient.valuationFileNo && formclient.valuationFileNo}</span>
</div>
  
 <h1 className="text-lg text-bold text-gray-600 py-4">Customer</h1>
  <div  class="grid grid-cols-1 gap-4 sm:grid-cols-1 lg:grid-cols-3  shadow-lg  bg-slate-500 border-2 py-7 px-3 rounded">
...

    {
      ...
      <button id="idsaveclientinfo" onClick={()=>verifyClientInfo()} className="mt-6 text-black w-full px-4 py-2 border hover:bg-green-800 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-green-900 cursor-pointer" >Verify</button>
     </>:        
        <div>
        <label className=" ">{}</label>
         <button id="idsaveclientinfo" onClick={()=>saveClientInfo()} className="mt-6 text-black w-full px-4 py-2 border hover:bg-green-800 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-400 cursor-pointer" >Save</button>
        </div>
  ...
  <div class="grid grid-cols-1 gap-4 sm:grid-cols-1 lg:grid-cols-3  shadow-lg  border-2 py-7 px-3 rounded bg-slate-500">
 ...
 
{
  ...
  <div><h1></h1></div>:
      ...
      <>  <label className=" ">{}</label>
      <button id="idsaveotherinfo" onClick={()=>verifyOtherDetail()} className="mt-6 text-black w-full px-4 py-2 border hover:bg-green-800 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-green-900 cursor-pointer" >Verify</button>
     </>:        
        <div>
        <label className=" ">{}</label>
         <button id="idsaveotherinfo" onClick={()=>saveOtherDetail()} className="mt-6 text-black w-full px-4 py-2 border hover:bg-green-800 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-400 cursor-pointer" >Save</button>
        </div>
  ...
  <div class="grid   bg-slate-500  grid-cols-1 gap-4 sm:grid-cols-1 lg:grid-cols-3  shadow-lg  border-2 py-7 px-3 rounded">
   ...
   formCost.costUpdateStatus==="cost-unverified" && formCost.costMaker!==user.email ?
      <>  <label className=" ">{}</label>
      <button id="idsaveotherinfo" onClick={()=>verifyCost()} className="mt-6 text-black w-full px-4 py-2 border hover:bg-green-800 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-green-600 cursor-pointer" >Verify</button>
     </>:        
        <div>
        <label className=" ">{}</label>
         <button id="idsaveotherinfo" onClick={()=>saveCostInfo()} className="mt-6 text-black w-full px-4 py-2 border hover:bg-green-800 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-400 cursor-pointer" >Save</button>
        </div>
...
{//--------------------------close
  ...
  <div class="grid grid-cols-1 bg-slate-500 gap-4 sm:grid-cols-1 lg:grid-cols-3  shadow-lg  border-2 py-7 px-3 rounded">
   ...
   formClose.closeUpdateStatus==="close-unverified" && formClose.closeMaker!==user.email ?
      ...
      <button id="idsaveotherinfo" onClick={()=>verifyClose()} className="mt-6 text-black w-full px-4 py-2 border hover:bg-green-800 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-green-600 cursor-pointer" >Verify</button>
      </div>
     </>:        
        <div>
        <label className=" ">{}</label>
         <button id="idsaveotherinfo" onClick={()=>saveClose()} className="mt-6 text-black w-full px-4 py-2 border hover:bg-green-800 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-400 cursor-pointer" >Save</button>
        </div>
